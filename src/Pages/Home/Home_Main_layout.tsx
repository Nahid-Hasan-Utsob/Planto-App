...
>
      ...
      <Hero_Cards></Hero_Cards>
        ...
        <Style_Common_Text className="md:text-[40px] text-[24px] md:my-21 py-10 text-white " text="Our Top Selling"></Style_Common_Text>
        <Top_selling></Top_selling>
        <Style_Common_Text className="text-[40px] my-21 text-white" text="Customer Review"></Style_Common_Text>
